...
# =============================================================================
# ALL-IN-ONE iMac Bootstrap -- curl this from a gist and run
# Usage: curl -fsSL <gist-raw-url> | bash -s imac
#   or:  bash imac-bootstrap.sh imac
#
# This is a self-contained version of 02-macos-headless-agent.sh with all
# dependencies (GPU detection, launchd plists) embedded inline.
# No relative paths or extra files needed.
# =============================================================================
...
echo "============================================"
echo "  Agent Mesh -- macOS Headless Bootstrap"
...
if command -v tailscale &>/dev/null && tailscale ping --timeout 3s "${ICECC_SCHEDULER}" &>/dev/null 2>&1; then
  ...
  echo ""
  echo "  Options:"
  echo "    1) Run this machine as a TEMPORARY SCHEDULER"
...
echo ""
echo "=========================================="
echo "  macOS Headless Agent ONLINE"
...
echo ""
echo "  When arch-orchestrator is back:"
